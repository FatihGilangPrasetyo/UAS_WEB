							...
							<table class="table table-hover table-bordered">
							  ...
							  <tbody>
								...
								<div class="btn-group">
								  ...
								  <a onclick="return confirm('Anda yakin ingin menghapus data tersebut?');" href="aksi_warga.php?act=delete&nik=<?php echo $row["nik"];?>" class="btn btn-xs btn-danger"> <i class="fa fa-remove" title='Hapus'></i> </a>
								</div>
								</td>
								</tr>
								<?php
